export default function ImageCard(props: any) {
    const {src, owner, special} = props;
    return (
        <div className="mx-1 my-3 border border-gray-300 max-w-sm rounded overflow-hidden shadow-lg">
            <img className=" w-full" src={src} key={src} alt="dog_images" />
            <div className="px-6 py-4">
                <div className="font-bold text-xl mb-2">{special ? `Special Guest: ${owner} Dog` : 'The Coldest Sunset'}</div>
