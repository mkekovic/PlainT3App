...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="leading-normal tracking-normal text-gray-900" >
        <div className="h-screen pb-14 bg-right bg-cover" style={{ backgroundImage: `url(/bg.svg)` }}>
          <div className="w-full container mx-auto p-6">

            <div className="w-full flex items-center justify-between">
              <div className="flex w-4/5 justify-end content-center">
          ...
          <div className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
              <h1 className="my-4 text-3xl md:text-5xl text-purple-800 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">Welcome to the Create T3 App</h1>
              <p className="leading-normal text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-subtitle">Explore the performance of this front end stack. Let's Start!</p>
            </div>
